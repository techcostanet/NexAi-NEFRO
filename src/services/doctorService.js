...
export const DEFAULT_DOCTORS = [
  {
    ...
    hospitalVinculo: "Hospital Escola Simulado Nex-Ai.NEFRO (Demonstração)",
    unidadeDialise: "Unidade de Hemodiálise e Diálise Peritoneal Simulada",
    bio: "Perfil demonstrativo para apresentação e testes clínicos do Nex-Ai.NEFRO. Contém pacientes fictícios de simulação de adequação dialítica, acessos vasculares e condutas nefrológicas.",
    statusLicenca: "Trial",
    ...
    locaisAtuacao: [
      ...
      { 
        id: "loc-02", 
        nome: "Hospital Escola Simulado Nex-Ai.NEFRO (Demonstração)", 
        tipo: "Hospital Geral", 
        cidade: "São Paulo/SP", 
